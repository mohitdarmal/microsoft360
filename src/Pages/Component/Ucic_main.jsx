...
export class Ucic_main extends Component {
  componentDidMount() {
    //ProgressHeightWidth();
   // ModuleDataTable();
  }
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped nowarp" id="table-1">
                        <thead>
                          <tr>
                            ...
                            <th>CUSTOMER NUMBER (CIF)</th>
                            <th>ACCOUNT STATUS (OPEN / CLOSE/ IN PROGRESS)</th>
                            <th>UCIC</th>
                            <th>GUCIC</th>
